...
*/
    public void onLogin(String email, String password){
        ...
        if(TextUtils.equals(answer, "No such email")) {
            ...
            User user = DataObjectManager.getInstance().createUser("Waiting For Real Name...", email, password);
            //Receive all other data from the database
            DatabaseConnection.getInstance().receiveCurrentUserInformation(user);

            //NOT USER EXCEPT DEVELOPMENT
            CurrentProfile.getInstance().getUser().setFirstName("Waiting For Real Name...");
            CurrentProfile.getInstance().getUser().setEmail(email);
            CurrentProfile.getInstance().getUser().setPassword(password);
    ...
    public void onRegistration(String name, String email, String password){
        ...
        if(TextUtils.equals(answer, "Email already registered")){
            ...
            Log.d("STATUS", "Registrated successfully");
            //Receive all user data from our given information
            DatabaseConnection.getInstance().receiveCurrentUserInformation(newUser);

            //NOT USE WHEN NOT IN DEVELOPMENT MODE
            CurrentProfile.getInstance().getUser().setFirstName(name);
            CurrentProfile.getInstance().getUser().setEmail(email);
            CurrentProfile.getInstance().getUser().setPassword(password);
